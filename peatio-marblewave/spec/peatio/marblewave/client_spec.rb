...
RSpec.describe Peatio::MarbleWave::Client do
  ...
  subject { Peatio::MarbleWave::Client.new(uri) }
    ...
    context :methodnotfound do
      ...
      it do
        expect { subject.json_rpc(:methodnotfound) }.to \
          raise_error(Peatio::MarbleWave::Client::ResponseError, "Method not found (-32601)")
      end
    end
    ...
    context :notfound do
      ...
      xit do
        expect { subject.json_rpc(:notfound) }.to \
          raise_error(Peatio::MarbleWave::Client::Error)
      end
    end
    ...
    context :connectionerror do
      ...
      it do
        expect { subject.json_rpc(:connectionerror) }.to \
          raise_error(Peatio::MarbleWave::Client::ConnectionError)
      end
    end
  end
end
