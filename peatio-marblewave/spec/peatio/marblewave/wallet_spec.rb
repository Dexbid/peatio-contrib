...
RSpec.describe Peatio::MarbleWave::Wallet do
  let(:wallet) { Peatio::MarbleWave::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::MarbleWave::Wallet.new }
    ...
    it "sets settings attribute" do
      ...
      expect(unconfigured_wallet.settings)
        .to eq(settings.slice(*Peatio::MarbleWave::Wallet::SUPPORTED_SETTINGS))
    end
  end
